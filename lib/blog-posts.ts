...
export const BLOG_POSTS: BlogPostMeta[] = [
  ...
  },
  {
    ...
    title: 'How to Stop Procrastinating: The Brain Science Behind Why You Wait (and How to Beat It)',
    description:
      'Procrastination is not a time management problem — it is an emotional regulation problem. Brain scans show procrastinators have an overactive limbic system fighting an under-trained prefrontal cortex. Here is the science, the 6 root causes, and the 7-step protocol that actually works.',
    publishedAt: '2026-05-26',
    readTimeMinutes: 9,
    tagline: 'Procrastination is an emotion problem, not a time problem. Here is the fix.',
    emoji: '🧠',
    keywords: [
  ...
  },
  {
    ...
    title: 'The Pomodoro Technique Explained: Why 25 Minutes Beats 4 Hours (Try the Timer)',
    description:
      'Francesco Cirillo invented it in the 1980s with a tomato-shaped kitchen timer. Today it is the most-used focus technique in productivity. The science: focused attention decays after 25 minutes — short breaks reset the curve. Here is the complete method, the 6 rules, and a working timer you can start now inside the post.',
    publishedAt: '2026-05-26',
    readTimeMinutes: 8,
    tagline: '25 minutes focus. 5 minutes rest. Repeat. Try the live timer inside.',
    emoji: '🍅',
    keywords: [
      'pomodoro technique',
      'pomodoro timer',
  ...
  {
    slug: 'dopamine-detox-7-days',
    title: 'Dopamine Detox: How to Reset Your Brain in 7 Days (The Science, Not the Hype)',
    description:
      'Dopamine detox is the most-searched productivity term on TikTok — and 90% of what is said about it is wrong. You cannot "deplete" dopamine. But you CAN reset your brain&rsquo;s reward sensitivity in a measurable 7 days by removing supernormal stimuli. Here is the actual science, what to cut, and why it works.',
    publishedAt: '2026-05-26',
    readTimeMinutes: 9,
    tagline: 'You cannot deplete dopamine. But you can reset your brain&rsquo;s reward sensitivity in 7 days.',
    emoji: '🧘',
    keywords: [
      'dopamine detox',
      'dopamine fasting',
  ...
  {
    slug: 'seinfeld-strategy-dont-break-the-chain',
    title: 'The Seinfeld Strategy: How "Don\'t Break the Chain" Builds Unstoppable Consistency',
    description:
      'A young Jerry Seinfeld told a comedian: get a wall calendar. Write a joke every day. Cross off the day with a big red X. After a few days, you have a chain — and your job becomes simply not to break it. The strategy is decades old and still produces the highest habit-completion rates in behaviour design. Here is why.',
    publishedAt: '2026-05-26',
    readTimeMinutes: 8,
    tagline: 'Cross off today. Tomorrow your only job is not breaking the chain.',
    emoji: '🔥',
    keywords: [
      'dont break the chain',
      'seinfeld strategy',
      'chain method',
      'daily consistency hack',
  ...
  {
    slug: 'parkinsons-law-deadline-leverage',
    title: 'Parkinson\'s Law: Why Work Expands to Fill Time (And How to Use Deadlines as Leverage)',
    description:
      'In 1955, C. Northcote Parkinson observed: "Work expands so as to fill the time available for its completion." Give yourself a week to do something, it takes a week. Give yourself two hours, often the same task gets done in two hours. Here is the science behind the law, when it works for you, and the 4 ways to weaponise it.',
    publishedAt: '2026-05-26',
    readTimeMinutes: 9,
    tagline: 'Give yourself 2 hours. The task takes 2 hours. Give yourself a week. It takes a week.',
    emoji: '⏳',
    keywords: [
      'parkinsons law',
      ...
      'parkinsons law examples',
      'self imposed deadlines',
      'time constraint productivity',
    ],
    accent: 'sky',
  },
  {
    slug: 'energy-management-vs-time-management',
    title: 'Energy Management vs Time Management: Why High Performers Manage Energy, Not Hours',
    description:
      'Tony Schwartz and Jim Loehr studied elite athletes and CEOs and concluded: "Energy, not time, is the fundamental currency of high performance." Time is fixed; energy is renewable. Here are the 4 dimensions of energy (physical, emotional, mental, spiritual), the daily energy curve to map them to, and the 6 practices that compound.',
    publishedAt: '2026-05-26',
    readTimeMinutes: 9,
    tagline: 'Time is fixed. Energy is renewable. Manage the renewable one.',
    emoji: '🔋',
    keywords: [
      'energy management',
